...
public class DaBaby extends HudElement {
   ...
   private static final Identifier TEXTURE = new Identifier("venomhack", "dababy.jpg");
   private float rainbowHue1;

   public DaBaby() {
      super("da-baby-lets-gooooo", "Displays the dababy .", 0, 0);
   }
